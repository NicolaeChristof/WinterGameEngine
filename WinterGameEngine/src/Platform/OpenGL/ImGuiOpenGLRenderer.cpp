...
// This will compile fine without this include however a lot of the definitions
// will come from the loader file instead of Glad which is not what we want, this
// include overwrites previous definitions
#include <glad/glad.h>
